...
//               type="submit"
//               disabled={loading}
//               className="border-2 mt-5 border-black w-full font-semibold bg-blue-400 text-white py-2 rounded-lg hover:bg-white hover:text-yellow-300 transition"
//             >
...
//           <Link
//             to="/register"
//             className="border-2 mt-5 border-white w-full font-semibold bg-blue-400 text-white px-8 py-2 rounded-lg hover:bg-white hover:text-blue-300 transition text-center"
//           >
//             SIGN UP
//           </Link>
//         </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        ...
        <div className="max-w-sm w-full">
          ...
          <form onSubmit={handleOtpVerification}>
            ...
            <button type="submit" disabled={loading} className="border-2 mt-5 border-black w-full font-semibold bg-blue-400 text-white py-2 rounded-lg hover:bg-white hover:text-yellow-300 transition">
              {loading ? "Verifying..." : "VERIFY"}
            </button>
          </form>
        </div>
