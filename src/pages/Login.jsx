    ...
    <div className="flex flex-col md:flex-row h-screen">
        ...
        <div className="max-w-sm w-full">
          <div className="flex flex-col items-center mb-12">
            <div className="rounded-full flex items-center justify-center mb-4">
              <img src={logo} alt="VoidTech Logo" className="h-24 w-auto" />
            </div>
          ...
          <form onSubmit={handleLogin}>
            ...
            <Link
              to="/password/forgot"
              className="font-semibold rounded-md text-black mb-12 block text-sm hover:underline"
            >
              Forgot Password?
            </Link>
      ...
      <div className="hidden md:flex w-1/2 bg-yellow-500 text-white flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
        <div className="text-center h-[400px] flex flex-col justify-center">
          ...
          <Link
            to="/register"
            className="border-2 mt-5 border-white w-full font-semibold bg-yellow-500 text-white px-8 py-2 rounded-lg hover:bg-white hover:text-yellow-300 transition text-center"
          >
            SIGN UP
          </Link>
        </div>
